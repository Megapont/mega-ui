export default {
  ...
  'xs-dark': '0px 1px 3px rgba(11, 12, 17, 0.1)',
  'sm-dark': '0px 2px 4px rgba(11, 12, 17, 0.1)',
  'md-dark': '0px 4px 8px rgba(11, 12, 17, 0.1)',
  'lg-dark': '0px 8px 16px rgba(11, 12, 17, 0.1)',
  'xl-dark': '0px 16px 24px rgba(11, 12, 17, 0.1)',
};
